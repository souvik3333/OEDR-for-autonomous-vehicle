...
class Curves:
  ...
  def plot(self, t = 4):
    ...
    for xl, xr, y in zip(xls, xrs, ys):
      cv2.line(self.out_img, (np.int64(xl - t), np.int64(y)), (np.int64(xl + t), np.int64(y)), (255, 255, 0), np.int64(t / 2))
      cv2.line(self.out_img, (np.int64(xr - t), np.int64(y)), (np.int64(xr + t), np.int64(y)), (0, 0, 255), np.int64(t / 2))
