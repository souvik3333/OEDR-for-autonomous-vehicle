...
# Plotting functions ---------------------------------------------------------------------------------------------------
def plot_one_box(x, img, color=None, label=None, line_thickness=None,additional_label_inf=None):
    ...
    if label:
        ...
        if(additional_label_inf!=None):
            cv2.rectangle(img, (c1[0]-20,c1[1]-20), (c2[0]-20,c2[1]-20), color, -1)
            cv2.putText(img, additional_label_inf, (c1[0], c1[1] - 20), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
